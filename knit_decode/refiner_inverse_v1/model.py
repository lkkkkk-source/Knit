...
def _require_torch() -> tuple[object, object]:
    ...
    try:
        ...
        raise ImportError("PyTorch is required for refiner_inverse_v1 models. Install with `pip install -e .[train]`.") from error
    return torch, nn


class RefinerTransformer:
...
class ConditionalPatchDiscriminator:
